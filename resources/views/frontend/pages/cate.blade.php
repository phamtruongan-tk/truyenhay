        ...
        <div class="row mt-3 content"> 
                <div class="col-lg-9 col-md-9 col-12 ">
                    <div class="content-left">
                        <h5><i class="fas fa-list"></i> <a class="text-light" href="{{route('getHome')}}">Truyện Hay</a> / {{Str::title($cate->c_name)}} </h5>
                        <div class="row ">
                            @if (count($books) == 0)
                                <div class="col-lg-4 col-md-6 col-sm-12 text-center"> Truyện sẽ được cập nhật sớm nhất ...</div>
                            @else
