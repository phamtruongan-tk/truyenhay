        ...
        <div class="row" style="display: block;">
            <div class="col-md-8 col-sm-8  ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{route('book.update',$book->b_id)}}" method="POST" enctype="multipart/form-data">
                            @csrf 
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="b_name" value="{{old('b_name',$book->b_name)}}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập tên truyện">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control ckeditor" name="b_summary"   id="b_summary" aria-describedby="emailHelp" placeholder="Nhập mô tả">{{old('b_summary',$book->b_summary)}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="b_author" value="{{old('b_author',$book->b_author)}}" id="b_author" aria-describedby="emailHelp" placeholder="Nhập tác giả">
